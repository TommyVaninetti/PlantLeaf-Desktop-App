...
============================================================
  ...
  Cross-validated metrics  (threshold = 0.220, target recall ≥ 0.9):
  Confusion matrix  TP=68  FP=58  FN=7  TN=124
  Recall       [PRIMARY] :  0.907   (68/75 clicks detected)
  Precision              :  0.540
  Specificity            :  0.681
  F1                     :  0.677
  AUC-ROC                :  0.835
  Accuracy               :  0.747   (not primary metric)
...
============================================================
  Threshold used:  0.220
  Confusion matrix  TP=14  FP=3  FN=2  TN=7
  Recall       [PRIMARY] :  0.875   (14/16 clicks detected)
  Precision              :  0.824
  Specificity            :  0.700
  F1                     :  0.848
  AUC-ROC                :  0.925
  Accuracy               :  0.808   (not primary metric)

  Per-session breakdown (Set B):
    Session                              clicks  detected  FP    recall
    ----------------------------------------------------------------------
    Aloe_acqua50ml_misurazione1_11032026_09      16        14     3  0.88
...
============================================================
  ...
  Model saved:  /Users/tommy/PlantLeaf_dev/PlantLeaf-Desktop-App/docs/autoclick/v5/pkl/plantleaf_svm_v5_nofitcoverage.pkl

  Inference usage:
    import joblib, numpy as np
    model = joblib.load('/Users/tommy/PlantLeaf_dev/PlantLeaf-Desktop-App/docs/autoclick/v5/pkl/plantleaf_svm_v5_nofitcoverage.pkl')
    pipe  = model['pipeline']
